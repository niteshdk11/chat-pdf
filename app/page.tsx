  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <header className="flex justify-between items-center p-4 h-16">
        ...
        {/* Right: Auth Buttons */}
        {/* Temporarily disabled to test localStorage issue */}
        <div className="flex items-center space-x-4">
          <button className="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-full hover:bg-gray-200">
            Sign In
          </button>
